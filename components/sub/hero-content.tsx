      ...
      <div className="w-full flex flex-col gap-5 justify-center m-auto text-center md:text-start">
        ...
        >
          ...
          <h1 className="text-[12px] md:text-[13px] text-gray-200 font-semibold">
            Software, Web Developer and ML Engineer
          </h1>
        </motion.div>
        ...
        >
          I&apos;m a Full Stack Software Engineer specializing in Web Development and Machine Learning. I enjoy learning new technologies quickly and working with teams to build scalable, maintainable applications. Check out my projects and skills below.
        </motion.p>
